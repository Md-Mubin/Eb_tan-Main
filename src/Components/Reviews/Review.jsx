        ...
        <>
            ...
            <section className='container flex flex-col gap-[90px] pb-[120px]'>
                <ul className='flex flex-col items-center gap-[21px]'>
                    ...
                    <p className='w-[526px] text-center font-inter font-medium text-lg text-[#A0A79A] leading-[145%]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's</p>
                </ul>

                {/* ------ Reviews ------ */}
                <ul className='flex gap-[105px] justify-center'>
