            ...
            <nav className='container pt-[33px]'>
                <ul className='flex justify-between items-center'>
                    ...
                    <li className='relative'>
                        ...
                        {/* toggle effect */}
                        <ul className={navItems ? "w-[150px] flex flex-col text-center gap-3 py-4 bg-[#ff9d9da8] absolute translate-x-[-120px] duration-500 opacity-1 rounded-2xl" : "w-[150px] flex flex-col text-center gap-3 py-4 bg-red-200 absolute translate-x-[50px] duration-500 opacity-0 pointer-events-none"}>
